    ...
    <div className="mx-auto w-full max-w-[360px] px-4 text-[14px] leading-[1.45] text-zinc-100 font-sans">
      ...
      <div className="mt-2 mb-3">
        ...
        <div className="mt-2 text-[16px] font-bold">
          Interview next steps — 3 roles that match you this week
        </div>
        <div className="mt-1 text-[13px] text-zinc-400">
          London, Berlin, Dublin — curated early-career roles based on your profile
        </div>
      </div>
      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4 shadow-[0_1px_2px_rgba(255,255,255,0.04)_inset,0_8px_24px_rgba(0,0,0,0.35)]">
        ...
        <div className="mt-4 rounded-lg border border-white/10 bg-white/[0.04] p-3">
          ...
          <a
            href="#"
            className="mt-2 inline-block rounded-md bg-gradient-to-r from-[#9A6AFF] to-[#6B4EFF] px-3 py-2 text-[13px] font-semibold shadow-[0_2px_10px_rgba(154,106,255,0.25)] hover:shadow-[0_4px_14px_rgba(154,106,255,0.35)]"
          >
            View role
          </a>
        </div>
        ...
        <div className="mt-3 rounded-lg border border-white/10 bg-white/[0.04] p-3">
          ...
          <a href="#" className="mt-2 inline-block rounded-md bg-white/10 px-3 py-2 text-[13px] font-semibold">
            View role
          </a>
        </div>
        ...
        <div className="mt-3 rounded-lg border border-white/10 bg-white/[0.04] p-3">
          <div className="flex items-center justify-between">
            <div className="font-semibold">Operations Intern · Stripe</div>
        ...
        <a
          href="#"
          className="mt-4 inline-flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-[#9A6AFF] to-[#6B4EFF] px-4 py-3 text-[14px] font-bold shadow-[0_2px_10px_rgba(154,106,255,0.25)] hover:shadow-[0_4px_14px_rgba(154,106,255,0.35)]"
        >
          See all matches
        </a>
