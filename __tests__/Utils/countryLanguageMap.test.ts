...
describe('countryLanguageMap', () => {
  ...
  describe('getEarlyCareerTerms', () => {
    ...
    it('should return terms for all supported languages', () => {
      const languages = ['en', 'de', 'fr', 'es', 'nl', 'it', 'pt', 'sv', 'da', 'no'];
  ...
  describe('hasEarlyCareerTerms', () => {
    it('should detect English early career terms', () => {
      expect(hasEarlyCareerTerms('Looking for a graduate engineer', 'en')).toBe(true);
    ...
    it('should detect German early career terms', () => {
      expect(hasEarlyCareerTerms('Wir suchen einen Praktikanten', 'de')).toBe(true);
      expect(hasEarlyCareerTerms('Werkstudent gesucht', 'de')).toBe(true);
      expect(hasEarlyCareerTerms('Berufseinsteiger willkommen', 'de')).toBe(true);
    });

    it('should detect French early career terms', () => {
      expect(hasEarlyCareerTerms('Nous cherchons un stagiaire', 'fr')).toBe(true);
    ...
    it('should return false when no terms found', () => {
      expect(hasEarlyCareerTerms('Senior developer with 10 years experience', 'en')).toBe(false);
      expect(hasEarlyCareerTerms('Experienced professional needed', 'en')).toBe(false);
    });
