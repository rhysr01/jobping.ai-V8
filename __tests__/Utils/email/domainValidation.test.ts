import { EMAIL_CONFIG, assertValidFrom } from '@/Utils/email/clients';
...
describe('Email Domain Validation', () => {
  ...
  describe('assertValidFrom', () => {
    it('should pass for valid getjobping.com addresses', () => {
      ...
      expect(() => assertValidFrom('JobPing <hello@getjobping.com>')).not.toThrow();
      expect(() => assertValidFrom('JobPing <support@getjobping.com>')).not.toThrow();
    });

    it('should fail for www.getjobping.com addresses', () => {
      expect(() => assertValidFrom('JobPing <noreply@www.getjobping.com>')).toThrow();
      expect(() => assertValidFrom('JobPing <hello@www.getjobping.com>')).toThrow();
    });
