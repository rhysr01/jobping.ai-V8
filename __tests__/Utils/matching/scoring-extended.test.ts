...
import type { UserPreferences, MatchScore } from '@/Utils/matching/types';
...
describe('ScoringService', () => {
  ...
  describe('calculateMatchScore', () => {
    ...
    it('should give high eligibility for early-career jobs', () => {
      ...
      const score = scoringService.calculateMatchScore(earlyCareerJob, mockUser);
    ...
    it('should give lower eligibility for non-early-career jobs', () => {
      ...
      const score = scoringService.calculateMatchScore(nonEarlyCareerJob, mockUser);
  ...
  describe('calculateConfidenceScore', () => {
    it('should calculate confidence score', () => {
      const confidence = scoringService.calculateConfidenceScore(mockJob, mockUser);
    ...
    it('should reduce confidence for unknown categories', () => {
      ...
      const confidence = scoringService.calculateConfidenceScore(unknownJob, mockUser);
      expect(confidence).toBeLessThan(1);
    });
  ...
  describe('generateMatchExplanation', () => {
    it('should generate explanation', () => {
      ...
      const explanation = scoringService.generateMatchExplanation(mockJob, score, mockUser);
  ...
  describe('scoreJobsForUser', () => {
    ...
    it('should sort by match score descending', () => {
      const jobs = [
        ...
        { ...mockJob, job_hash: 'hash2', categories: ['early-career', 'career:tech'] },
      ];
      const results = scoringService.scoreJobsForUser(jobs, mockUser);
      if (results.length > 1) {
