...
describe('ScoringService', () => {
  ...
  describe('generateMatchExplanation', () => {
    it('should generate excellent explanation for high scores', () => {
      ...
      const explanation = scoringService.generateMatchExplanation(job, score, user);
  ...
  describe('scoreJobsForUser', () => {
    it('should score and sort jobs by match score', () => {
      const jobs = [
        ...
        buildMockJob({ id: '2', categories: ['early-career', 'tech'], title: 'Job 2' }),
    ...
    it('should accept custom config', () => {
      const customConfig = {
        scoring: {
          ...
          confidence: { uncertain_penalty: 0.1, unknown_penalty: 0.2, floor: 0.3 },
