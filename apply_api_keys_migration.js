...
-- Insert a test API key for development (using the correct hash)
...
async function applyAPIKeysMigration() {
  console.log('🔑 Applying API Keys Migration...');
